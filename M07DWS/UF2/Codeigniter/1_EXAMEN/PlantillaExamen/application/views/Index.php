	...
	<div class="login">
        ...
        <form name="f1" id="fLogin" method="post" action="<?php echo site_url('Index/checkLogin');?>">
          <div class="form-group">
            ...
            <input type="email" class="form-control" id="fmail" name="fmail" aria-describedby="emailHelp" placeholder="Correu electrònic">
            <small id="emailHelp" class="form-text text-muted">No compartirem mai la teva adreça amb cap altre persona.</small>
          </div>
          <div class="form-group">
        ...
        <a href="<?php echo site_url('Index/cpublic');?>">Vull veure la informació sense registrar-se.</a>
