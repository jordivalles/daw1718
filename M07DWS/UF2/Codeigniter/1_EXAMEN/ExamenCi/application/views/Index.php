	...
	<div class="login">
        ...
        <form name="f1" id="fLogin" method="post" action="<?php echo site_url('Index/checkLogin');?>">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="fmail" name="fmail" aria-describedby="emailHelp" placeholder="Correu electrònic">
          </div>
          <div class="form-group">
        ...
        <a href="<?php echo site_url('Index/loadRegistre');?>">Registra't aquí!</a>
