...
<body>
	...
	<div class="login">
		<form name="f1" id="fRegistre" method="post" action="<?php echo site_url('Index/checkRegistre');?>">
		  ...
		  <div class="form-group">
			...
			<input type="mail" id="fmail" name="fmail" value="<?php if(isset($mail)){echo $mail;}?>" placeholder="Correu electrònic"/>
		  </div>
		  <div class="form-group">
	...
	<a href="<?php echo site_url('Index/index');?>">Anar a la pàgina principal</a>
